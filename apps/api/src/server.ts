...
import { premiumDiscountRoutes } from "./routes/premium-discount";
...
app.register(deltaRoutes, { prefix: "/api" });
...
app.register(premiumDiscountRoutes, { prefix: "/api" });
app.register(tickerRoutes, { prefix: "/api" });
